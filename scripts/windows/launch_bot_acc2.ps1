...
# Ensure ACC2 telegram vars are used (config uses TELEGRAM_BOT_TOKEN_ACC2 / TELEGRAM_CHAT_ID_ACC2)
Write-Host "[ACC2] MT5_BRIDGE_URL=$($env:MT5_BRIDGE_URL)"
Write-Host "[ACC2] Config: configs/live_acc2.yaml"
python -m xauusd_ai.app live --config configs/live_acc2.yaml
