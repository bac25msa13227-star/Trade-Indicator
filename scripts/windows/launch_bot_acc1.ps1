# launch_bot_acc1.ps1 — Start live bot ACC1 (270832477 / port 5600)
...
Write-Host "[ACC1] Config: configs/live_acc1_scalp_m1.yaml"
python -m xauusd_ai.app live --config configs/live_acc1_scalp_m1.yaml
