@echo off
title XAUUSD Bot ACC1 - scalp_m1_reversal
...
echo [ACC1] Config: configs/live_acc1_scalp_m1.yaml
echo [ACC1] Model: outputs/acc1_scalp_m1_reversal_model.pkl

python -m xauusd_ai.main live --config configs/live_acc1_scalp_m1.yaml >> logs\bot_acc1.log 2>&1
